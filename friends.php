...
<div class="menu-bar hidden-xs hidden-sm">
    ...
    <div class="collapse navbar-collapse" id="example-navbar-collapse-1">    
      ...
      <li style="margin-right:12px;"><a href="index.php"><i class="fa fa-newspaper-o"></i> Newsfeed</a></li>
            ...
            <li style="margin-right:12px;margin-left:4px;border-bottom:2px solid #428bca;"><a href="friends.php"><i class="fa fa-users"></i> Friends</a></li>
...
<div class="btn-group btn-group-justified hidden-lg hidden-md  " style="color:#000; background:#428bca;" role="group" aria-label="Mobile Menu">
	<a class="btn btn-xs" href="index.php" style="color:#fff; font-size:225%; font-weight:bolder;   postion:absolute;">Da7aBook</a> 
 <form>
<div class=" input-group" style="margin-left:25%; postion:absolute; padding:12px;">
     <input type="text" name="q" class="form-control" placeholder="Da7aBook search">
    ...
    <div class="btn-group btn-group-justified hidden-lg hidden-md " role="group" aria-label="Mobile Menu">
      <a class="btn btn-default" style="color:#000; font-weight:bolder; background:#428bca; border:1px solid rgba(0,0,0,.2);" href="index.php"><strong><i class="fa fa-newspaper-o"></i></strong></a>
           ...
           <a class="btn btn-default" style="color:#fff; background:#428bca; border:1px solid rgba(0,0,0,.2);" href="friends.php"><i class="fa fa-users"></i> </a>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <div class="media-left">
   <a href="profile.php?id=1" class="black">
<img src="images/mike.jpg" width="75px" height="75px" class="media-object img-circle">
    </a>
  </div>
  <div class="media-body">
    <h4 class="media-heading"><strong><a href="profile.php?id=1" class="black">Mike Tavish</a></strong></h4>
    &nbsp;<i class="fa fa-map-marker"></i> California, USA
  <div class="friend-list-item black">
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-users "></i> <span class="black">112 Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;👬 <span class="black"> 28 Mutal Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-up "></i><span class="black">  288 Like for You</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-down "></i> <span class="black"> 62 Dislike for You</span></a>
  <a href="#" style="color:red;" data-toggle="tooltip" data-placement="top" title="Un friend">&nbsp;<i class="fa fa-user-times "></i></a>
  </div>
</div>
</div>
</div>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <div class="media-left">
   <a href="profile.php?id=2" class="black">
<img src="images/moun.jpg" width="75px" height="75px"  class="media-object img-circle ">
    </a>
  </div>
  <div class="media-body">
    <h4 class="media-heading"><strong><a href="profile.php?id=2" class="black">Morwin case</a></strong></h4>
    &nbsp;<i class="fa fa-map-marker"></i> Berlin, GR
  <div class="friend-list-item black">
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-users "></i> <span class="black">45 Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;👬 <span class="black"> 5 Mutal Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-up "></i><span class="black">  88 Like for You</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-down "></i> <span class="black"> 6 Dislike for You</span></a>
  <a href="#" style="color:red;" data-toggle="tooltip" data-placement="top" title="Un friend">&nbsp;<i class="fa fa-user-times "></i></a>
  </div>
</div>
</div>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <div class="media-left">
   <a href="profile.php?id=3" class="black">
<img src="images/lewis.jpg" width="75px" height="75px"  class="media-object img-circle ">
    </a>
  </div>
  <div class="media-body">
    <h4 class="media-heading"><strong><a href="profile.php?id=3" class="black">sidahmed mohamed </a></strong></h4>
    &nbsp;<i class="fa fa-map-marker"></i> Newyork, USA
  <div class="friend-list-item black">
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-users "></i> <span class="black">89 Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;👬 <span class="black"> 56 Mutal Friends</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-up "></i><span class="black">  235 Like for You</span></a>
  <a href="#" style="border-right:1px solid rgba(0,0,0,.2); padding-right:12px">&nbsp;<i class="fa fa-thumbs-o-down "></i> <span class="black"> 54 Dislike for You</span></a>
  <a href="#" style="color:red;" data-toggle="tooltip" data-placement="top" title="Un friend">&nbsp;<i class="fa fa-user-times "></i></a>
  </div>
</div>
</div>
