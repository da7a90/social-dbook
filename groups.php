...
<div class="menu-bar hidden-xs hidden-sm">
    ...
    <div class="collapse navbar-collapse" id="example-navbar-collapse-1">    
		<ul class="nav navbar-nav ">
			...
			<li style="margin-right:12px;margin-left:4px;border-bottom:2px solid #428bca;"><a href="groups.php"><sup><i class="glyphicon glyphicon-user"></i></sup><i class="glyphicon glyphicon-user"></i><sup><sup><i class="glyphicon glyphicon-user"></i></sup></sup> &nbsp; Groups </a></li>			
...
<div class=" input-group" style="margin-left:25%; postion:absolute; padding:12px;">
    ...
    <div class="btn-group btn-group-justified hidden-lg hidden-md " role="group" aria-label="Mobile Menu">
      <a class="btn btn-default" style="color:#000; font-weight:bolder; background:#428bca; border:1px solid rgba(0,0,0,.2);" href="index.php"><strong><i class="fa fa-newspaper-o"></i></strong></a>
		   ...
		   <a class="btn btn-default" style="color:#fff;  background:#428bca; border:1px solid rgba(0,0,0,.2);" href="groups.php"><sup><i class="glyphicon glyphicon-user"></i></sup><i class="glyphicon glyphicon-user"></i><sup><sup><i class="glyphicon glyphicon-user"></i></sup></sup> </a>			
...
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">Hacker Group</a></div>
<img src="images/hdwallpaper.jpeg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
    <span class="badge">14</span>
    <span style="border-right:1px solid rgba(0,0,0,.2); padding-right:7px;margin-right:7px;"> <i class="fa fa-users"></i> </span> Members
  </li>
  <li class="list-group-item">
    <span class="badge">66</span>
    <span style="border-right:1px solid rgba(0,0,0,.2); padding-right:7px;margin-right:7px;"> <i class="fa fa-thumbs-o-up"></i> </span> Total Likes
  </li>
  <li class="list-group-item">
    <span class="badge">32</span>
    <span style="border-right:1px solid rgba(0,0,0,.2); padding-right:7px;margin-right:7px;"> <i class="fa fa-thumbs-o-down"></i> </span> Total Dislikes
  </li>
</ul>
<br>
</div>
...
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">Cricketer</a></div>
<img src="images/cricketer.jpg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
    <span class="badge">14</span>
  ...
  <li class="list-group-item">
    <span class="badge">32</span>
    <span style="border-right:1px solid rgba(0,0,0,.2); padding-right:7px;margin-right:7px;"> <i class="fa fa-thumbs-o-down"></i> </span> Total likes
  </li>
</ul>
<br>
</div>
...
<div class="col-md-4 box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">I love Google</a></div>
<img src="images/I_love_google.jpg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
    <span class="badge">14</span>
...
<div class="row">
<div class="col-md-4 box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">MAKE IN INDIA</a></div>
<img src="images/Make_In_India.jpg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
    <span class="badge">14</span>
...
<div class="col-md-4 box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">I Love Movies</a></div>
<img src="images/I_love_movies.jpg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
    <span class="badge">14</span>
...
<div class="col-md-4 box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;"><a class="page-title" href="#" align="center">Food Lovers</a></div>
<img src="images/I_love_movies.jpg" class="img-responsive box-shadow">
<div style="background:#fff; padding-left:16px;padding-right:16px;min-height:45px; padding-top:12px; box-shadow: 1px  0 15px rgba(0,0,0,.2); margin:0 !important;">
<ul class="list-group">
  <li class="list-group-item">
